...
public class Usuario implements Serializable {
	...
	public Usuario(Long id, @NotEmpty String nick, @NotEmpty String email, @NotEmpty String password,
			@NotEmpty String nombre, @NotEmpty String apellido, @NotEmpty String direccion, @NotEmpty String telefono) {
		super();
		this.id = id;
		this.nick = nick;
		this.email = email;
	...
	public Usuario(@NotEmpty String nick, @NotEmpty String email, @NotEmpty String password, @NotEmpty String nombre,
			@NotEmpty String apellido, @NotEmpty String direccion, @NotEmpty String telefono) {
		super();
		this.nick = nick;
		this.email = email;
		this.password = password;
