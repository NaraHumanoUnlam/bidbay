...
public class TestProducto {
	...
	public void seCreaProductoConTodosLosDatos() {
		Producto producto = new Producto(3L,"Remera de prueba", "esto es una prueba para los TDD", 2000.00,45);
	...
	public void seCreaUsuarioConDatosSinId() {
		Producto producto = new Producto("Remera de prueba", "esto es una prueba para los TDD", 2000.00,45);
		Assert.isTrue(producto!=null);
	}
